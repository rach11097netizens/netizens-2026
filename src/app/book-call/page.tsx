...
export const metadata: Metadata = {
    title: "Book a Discovery Call for Product Development | Netizens",
    description: "Book a discovery call to plan your MVP, improvements, or automation. We'll align on scope and expectations, then share a practical next-step plan within 24 hours.",
};
