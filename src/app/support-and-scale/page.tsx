...
export const metadata: Metadata = {
    title: "Post-Launch Support & DevOps for Scaling Products | Netizens",
    description: "Structured support retainers for production apps: SLAs, DevOps monitoring, performance optimization, security hardening, and continuous delivery improvements.",
    keywords: ["software maintenance services"],
};
...
export default function SupportScalePage() {
    return (
