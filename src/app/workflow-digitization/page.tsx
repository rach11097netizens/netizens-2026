...
export const metadata: Metadata = {
    title: "Workflow Digitization & Business Workflow Automation Services",
    description: "Streamline approvals, reporting, and handoffs with workflow digitization. Get ERP/CRM customization, system integrations, and automation that scales with your teams.",
    keywords: ['Workflow Digitization'],
};
...
export default function WorkflowDigitPage() {
    return (
