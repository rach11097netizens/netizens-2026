...
export function AboutHero({
  ...
  return (
    <section className="relative w-full max-w-3xl mx-auto px-4 py-8 md:py-24 flex flex-col items-center justify-between overflow-hidden z-10">
      <div className="flex flex-col items-center md:items-start justify-center w-full text-center md:text-left gap-6">
        ...
        <h1 className="font-headings font-normal text-2xl sm:text-4xl md:text-[46px] leading-[1.1] md:leading-[1.1] text-carbon-black capitalize">
          {heading}
        </h1>
