        ...
        >
            ...
            <div className="max-w-[1320px] mx-auto px-5 md:px-10 py-[80px] relative">
                        ...
                        {tabsData.map((tab, idx) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`builders-tab cursor-pointer rounded-[10px] p-[18px] transition-colors duration-300 flex flex-col gap-[18px] ${isActive
                ...
                >
                    ...
                    <BookCallButton className="shrink-0" />
                </div>
            </div>
        </section>
    )
