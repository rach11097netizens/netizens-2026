...
export function ServiceCTASection({
    ...
    return (
        <section className="relative w-full bg-regal-navy flex flex-col items-center py-20 overflow-hidden">
            ...
            <div className="w-full max-w-5xl mx-auto px-4 relative z-10 flex flex-col items-center justify-center text-center gap-8">
                <div className="flex flex-col gap-4 items-center">
                    <h2 className="font-headings font-normal text-2xl lg:text-3xl xl:text-[46px] xl:leading-[56px] text-white">
                        {heading}
                    </h2>
                    <p className="font-sans font-medium text-sm sm:text-base leading-relaxed text-white/90 max-w-xl">
                        {description}
                    </p>
                </div>

                <div className="flex flex-col gap-4 items-center w-full max-w-[412px]">
                    <BookCallButton variant="white" showArrow={false}>
                        {ctaLabel}
                    </BookCallButton>
                    {subtext && (
